...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      {/* Header */}
      <header
        className="fixed top-0 inset-x-0 z-60 flex items-center justify-between px-6 py-3"
        style={{
          backgroundColor: "var(--bg)",
          borderBottom: "1px solid color-mix(in srgb, var(--secondary) 30%, transparent)",
        }}
      >
        <nav className="flex items-center gap-8 text-[11px] tracking-[0.18em] uppercase">
          ...
          <a href="#" className="font-bold transition-colors duration-150" style={{ color: "var(--secondary)" }}>Consola</a>
          <a href="#" className="transition-colors duration-150 hover:text-(--secondary)" style={{ color: "color-mix(in srgb, var(--secondary) 50%, transparent)" }}>Red</a>
          <a href="#" className="transition-colors duration-150 hover:text-(--secondary)" style={{ color: "color-mix(in srgb, var(--secondary) 50%, transparent)" }}>Archivo</a>
        </nav>
        <div className="flex items-center gap-4" style={{ color: "color-mix(in srgb, var(--secondary) 60%, transparent)" }}>
          {/* Signal icon */}
